...
struct line 
{
    ...
    inline double coefficient (line L);
    inline pair<double, double> coefficients (point centre, double rsqr); //note radius squared is asked for
...
inline line produce (point const &a, point const &b)
    {return {a, b - a};}
