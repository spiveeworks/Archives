...
call :stencil key;colour{gray;red;black;blue;brown;green;purple;cyan;pink;white;sky;orange;lime;magenta}condition{stable;fragile}
call :stencil door;colour{gray;red;black;blue;brown;green;purple;cyan;pink;white;sky;orange;lime;magenta}protection{unlocked;locked;overiden}
call :stencil bucket;colour{gray;red;black;blue;brown;green;purple;cyan;pink;white;sky;orange;lime;magenta}state{full;empty}

call :output equals It is already that colour :P
call :output colourchange They are now equal in colour, and so their souls are in harmony.
call :output aunlock This door is already unlocked.
call :output aunlock You cannot unlock the door after performing a manual over-ride on it.
call :output wunlock The door unlocked :D
call :output incompat The key didn't fit.
call :output disintegrate The key disintegrated.

call :event paint key bucket if object.colour == instrument.colour {print equals;} else {set object.colour = instrument.colour; print colourchange;}
call :event unlock door key if object.protection == overiden {print sunlock;} else {if object.protection == unlocked {print aunlock;} else {if object.colour == instrument.colour {print wunlock; set object.protection = unlocked; if instrument.condition == fragile {print disintegrate;}} else {print incompat;}}}


call :object key on the floor;gray
call :object key hanging on the wall;fragile;blue
call :object door;blue;locked
call :object door;green;locked
call :object door;red;
call :object door;locked
call :object bucket balanced on your head;green
call :object bucket sitting by the red door;red